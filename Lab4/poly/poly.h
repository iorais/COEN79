...
namespace coen79_lab4 {
    class polynomial {
    public:
        static const unsigned int MAXIMUM_DEGREE = 29; // maximum exponent
        double coefficients[MAXIMUM_DEGREE + 1]; // array of coeffecients
        ...
        // NOTE: For exponents > MAXIMUM_DEGREE, the return value is always zero.
        double coefficient(unsigned int exponent) const { 
            return exponent > MAXIMUM_DEGREE ? 0 : coefficients[exponent]; 
        }
        ...
        // POSTCONDITION: The return value is the value of this polynomial with the
        // given value for the variable x.
        // NOTE: Same as the eval member function.
        double operator( ) (double x) const;
